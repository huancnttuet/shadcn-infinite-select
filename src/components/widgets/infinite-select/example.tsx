...
import InfiniteSelect, { Option } from '@/components/widgets/infinite-select';
import { FilterIcon } from 'lucide-react';
import { useState } from 'react';

export default function InfiniteSelectExample() {
...
async function getProducts(page: number, searchTerm?: string) {
  const products = [
    {
      id: 1,
